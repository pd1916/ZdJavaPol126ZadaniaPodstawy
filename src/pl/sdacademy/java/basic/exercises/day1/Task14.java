...
public class Task14 {
    ...
    /*
    Do operacji na pieniądzach powinno się używać typu BigDecimal,
    który jest dedykowany do tego typu wyliczeń
    Dla chętnych do poczytania: https://www.baeldung.com/java-bigdecimal-biginteger
    Dla jeszcze bardziej chętnych: spróbujcie przerobić to zadania z użyciem BigDecimal
     */
